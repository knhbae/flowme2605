-- M7-2 DEV only: two frozen OPIC single-day locators. No account/data writes.
-- Preparation only until an explicit DEV rollout; deploy the matching reader afterward.
