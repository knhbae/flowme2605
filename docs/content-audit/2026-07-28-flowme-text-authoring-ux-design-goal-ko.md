...
3. 실제 Flow 콘텐츠와 projection 근거
   - [Qualified Corpus v2](../specs/2026-07-28-flow-item-map-architecture-qualified-corpus-revalidation-v2/qualified-corpus-fixture-v2.json)
   - [Projection Matrix v2](../specs/2026-07-28-flow-item-map-architecture-qualified-corpus-revalidation-v2/projection-matrix-v2.json)
   - [Projection Loss Manifest v2](../specs/2026-07-28-flow-item-map-architecture-qualified-corpus-revalidation-v2/projection-loss-manifest-v2.json)
   - [Input Lineage v2](../specs/2026-07-28-flow-item-map-architecture-qualified-corpus-revalidation-v2/input-lineage-v2.json)
   - [Round-trip Results v2](../specs/2026-07-28-flow-item-map-architecture-qualified-corpus-revalidation-v2/round-trip-results-v2.json)
   - [Todo fixtures](../specs/2026-07-27-flow-item-map-architecture-creator-portfolio-category-fit-lab-v1/fixtures/todo/)
   - [Sheet fixtures](../specs/2026-07-27-flow-item-map-architecture-creator-portfolio-category-fit-lab-v1/fixtures/sheet/)
...
4. 기존 시뮬레이션과 사용자 방향
   ...
   - [사용자 피드백 통합본](./2026-07-26-flowme-user-feedback-synthesis-ko.txt)
...
아래 문구와 이 문서의 전체 경로를 함께 전달한다.

```text
FlowMe의 실제 콘텐츠와 canonical 데이터 계약을 근거로, Wiki·Obsidian처럼 텍스트를
작성하거나 붙여넣어 Flow 콘텐츠를 만드는 UX를 기획해줘.

먼저 다음 목표 문서를 처음부터 끝까지 읽고 Phase 0 evidence package부터 만든다.

D:\flowme2605\flow-mvp\docs\content-audit\2026-07-28-flowme-text-authoring-ux-design-goal-ko.md
