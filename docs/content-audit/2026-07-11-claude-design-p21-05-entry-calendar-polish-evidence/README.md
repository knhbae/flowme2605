# FlowMe Claude Design P21-05 Home and Calendar Polish Evidence

- Generated: 2026-07-10T15:59:40.232Z
- Branch: `main`
...
- 홈 URL/memo entry는 `Flow 찾기 · 링크 붙여넣기` 구분을 유지하며 붙음 hit가 0이다.
- Calendar 월간 grid의 주요 2개 Flow는 색뿐 아니라 안정적인 한 글자 마커와 짧은 label을 함께 사용한다.
- 같은 날짜 4개 Flow fixture에서 grid는 2개 label과 `외 2개`만 보여주고, selected-day agenda는 4개 Flow 전체를 유지한다.
- 새 short-label schema나 slug 전용 하드코딩을 추가하지 않았다.

핵심 marker: `homeUrlFirstEntrySeparatorPresent: true`, `homeUrlFirstEntryConcatenatedLabelCount: 0`, `calendarGridVisibleFlowLabelCount: 2`, `calendarGridDistinctVisibleMarkerIdentityCount: 2`, `calendarGridOverflowSummaryVisible: true`, `calendarSelectedDayAgendaShowsAllFlows: true`, `calendarGridHorizontalOverflowCount: 0`.
