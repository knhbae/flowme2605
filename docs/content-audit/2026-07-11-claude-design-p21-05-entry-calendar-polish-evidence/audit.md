# Claude Design P21-05 Home and Calendar Polish Evidence Audit
...
{
  "totalScreenshots": 68,
  "uiBaselineCommit": "fddf6c8",
  "packageGeneratedFromCommit": "fddf6c8",
...
| 30-url-first-candidate-detail-mobile | `/flows` | URL-first saved candidate request detail | OK | 0 | 0 | 0 | 0 | 1 |
| 39e-url-first-draft-studio-shelf-mobile | `/u/my-flow-studio` | URL-first draft in Studio draft shelf mobile | OK | 0 | 0 | 0 | 0 | 0 |
| 39f-url-first-draft-studio-shelf-wide | `/u/my-flow-studio` | URL-first draft in Studio draft shelf wide | OK | 0 | 0 | 0 | 0 | 0 |
| 39a-url-first-draft-item-edit-entry-mobile | `/my` | URL-first draft item edit entry in My Flow | OK | 0 | 0 | 0 | 0 | 0 |
| 39b-url-first-draft-anchor-edit-mobile | `/my` | URL-first draft anchor edit policy in My Flow mobile | OK | 0 | 0 | 0 | 0 | 1 |
| 39c-url-first-draft-anchor-edit-wide | `/my` | URL-first draft anchor edit policy in My Flow wide | OK | 0 | 0 | 0 | 0 | 1 |
| 39d-url-first-draft-calendar-export-mobile | `/calendar` | URL-first draft Calendar and export projection | OK | 0 | 0 | 0 | 0 | 0 |
| 45-draft-save-failure-mobile | `/flows` | Draft save failure with preserved input mobile | OK | 0 | 0 | 0 | 0 | 1 |
| 45-draft-save-failure-wide | `/flows` | Draft save failure with preserved input wide | OK | 0 | 0 | 0 | 0 | 1 |
| 46-draft-duplicate-mobile | `/flows` | Duplicate draft returns to existing saved draft mobile | OK | 0 | 0 | 0 | 0 | 0 |
| 46-draft-duplicate-wide | `/flows` | Duplicate draft returns to existing saved draft wide | OK | 0 | 0 | 0 | 0 | 0 |
| 47a-draft-empty-my-flow-mobile | `/my` | Empty My Flow recovery entry mobile | OK | 0 | 0 | 0 | 0 | 0 |
| 47a-draft-empty-my-flow-wide | `/my` | Empty My Flow recovery entry wide | OK | 0 | 0 | 0 | 0 | 0 |
| 47b-draft-empty-calendar-mobile | `/calendar` | Empty Calendar recovery entry mobile | OK | 0 | 0 | 0 | 0 | 0 |
| 47b-draft-empty-calendar-wide | `/calendar` | Empty Calendar recovery entry wide | OK | 0 | 0 | 0 | 0 | 0 |
| 48-draft-completed-zero-mobile | `/my` | Draft completed with zero remaining mobile | OK | 0 | 0 | 0 | 0 | 0 |
| 48-draft-completed-zero-wide | `/my` | Draft completed with zero remaining wide | OK | 0 | 0 | 0 | 0 | 0 |
| 49-draft-offline-local-action-mobile | `/my` | Already-open draft local action while offline mobile | OK | 0 | 0 | 0 | 0 | 0 |
| 49-draft-offline-local-action-wide | `/my` | Already-open draft local action while offline wide | OK | 0 | 0 | 0 | 0 | 0 |
...
| 12b-public-new-car-post-save-my-flow-mobile | `/my` | Public share post-save My Flow completion boundary | OK | 0 | 0 | 0 | 0 | 0 |
...
| 43b-calendar-grid-flow-stack-mobile | `/calendar` | Calendar grid compact same-date Flow stack mobile | OK | 0 | 0 | 0 | 0 | 0 |
...
| 44b-calendar-grid-flow-stack-wide | `/calendar` | Calendar grid compact same-date Flow stack wide | OK | 0 | 0 | 0 | 0 | 0 |
...
| 38-url-first-candidate-detail-wide | `/flows` | URL-first candidate detail wide viewport guardrail spot check | OK | 0 | 0 | 0 | 0 | 1 |
