# Claude Design P21-01 Draft Content Audit

## Scope

이번 slice는 P20에서 열린 URL-first miss 초안 경로 안에 실제로 손볼 수 있는 내용을 채운다. 사용자 제목과 메모를 결정론적으로 3~7개 실행 후보로 나누고, 각 항목에 기준일 오프셋을 부여한다. 저장 전 full editor나 실제 AI 생성은 추가하지 않는다. 저장 후 My Flow의 포함 여부·제목·날짜·메모 편집, Calendar, export projection을 재사용한다.

판정: P21-01 구현 완료. 현재 fixture의 제안 항목은 3개이고 기준일 날짜 투영은 true다. live-AI 암시, URL-first internal copy, visible Markdown, normal/wide 구조 표시 hit은 모두 0이다. P21-04의 실패·빈·완료 후·오프라인·중복 상태 evidence는 별도 후속 slice로 남긴다.
...
{
  "totalScreenshots": 56,
  "uiBaselineCommit": "fc700a1",
  "packageGeneratedFromCommit": "fc700a1",
  "packageCommitRef": "git commit containing this generated package",
  "wideViewportEvidenceCount": 13,
  ...
  "wideViewportGuardrailRouteCount": 13,
  ...
  "normalRouteInputRawIsoExemptCount": 13,
  ...
  "progressMetricContextLabelCount": 26,
