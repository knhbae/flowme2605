# FlowMe Claude Design P20 Final Review Package

- Generated: 2026-07-10T08:07:16.294Z
- Branch: `main`
- UI baseline commit: `88a4dd5`
- Package generated from commit: `88a4dd5`
...
- Normal route trailing Flow/map phrase hits: 2
- Normal route raw ISO hits: 0
- Normal route input raw ISO hits: 0
- Normal route native date input raw ISO exemptions: 11
...
- My Flow item edit accessible names: ["원문에서 필요한 단계 정리하기 제목·날짜·메모 수정","내 일정에 맞춘 첫 단계 제목·날짜·메모 수정","임대차 계약 확정일자 부여 여부 확인하기 제목·날짜·메모 수정"]
...
- URL-first miss draft editable item count: 1
