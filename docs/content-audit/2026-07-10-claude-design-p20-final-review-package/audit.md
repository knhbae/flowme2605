# Claude Design P20 Guardrail Audit
...
{
  "totalScreenshots": 56,
  "uiBaselineCommit": "88a4dd5",
  "packageGeneratedFromCommit": "88a4dd5",
  ...
  "homeUrlFirstEntryLabel": [
    "URL이나 메모로 Flow 찾기링크 붙여넣기 · 요청 메모 · 준비된 Flow 확인"
  ],
  ...
  "homeUrlFirstEntryEvidence": [
    {
      ...
      "viewportWidth": 390,
      "visible": true,
      "label": "URL이나 메모로 Flow 찾기링크 붙여넣기 · 요청 메모 · 준비된 Flow 확인",
      "destination": "/flows",
      "aboveFold": true,
      "rect": {
        "x": 20,
  ...
  "wideViewportStructuralDisplayHitCount": 2,
  ...
  "normalRouteStructuralDisplayHitCount": 2,
  "normalRouteRawIsoHitCount": 0,
  "normalRouteInputRawIsoHitCount": 0,
  "normalRouteInputRawIsoExemptCount": 11,
  ...
  "taskCompleteControlPatternEvidence": [
    {
      ...
      "checkboxSamples": [
        {
          "surface": "route",
          "accessibleName": "원문에서 필요한 단계 정리하기 완료 체크",
          "checked": false
        }
      ],
      "buttonSamples": []
  ...
  "urlFirstCandidateCardTextSamples": [
    {
      ...
      "lines": [
        ...
        "첫 할 일을 My Flow에 포함",
        "첫 할 일 제목",
        "첫 할 일 메모URL에서 따라 할 순서만 남겨두고 싶음",
        "내 Flow에 초안 저장",
        "직접 입력한 초안으로 저장",
        "요청 내용 닫기",
        "원 URL 열기",
  ...
  "draftFlowEvidence": [
    ...
    },
    {
      ...
      "exportSampleLength": 199,
      "exportSampleHash": "f27f95364443ac018445b4f35fd00d0809bd88a71214be6fb14f0fdd1d2afdcf"
    }
  ],
