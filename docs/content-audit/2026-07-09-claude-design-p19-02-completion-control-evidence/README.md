...
- Generated: 2026-07-09T12:46:06.381Z
- Branch: `main`
...
P19-02 unifies task completion controls in My Flow and Calendar around a single row-left checkbox pattern. `열기` remains the detail/navigation action, while detail-level `확인 항목` checkboxes and public `/f` pre-save preview checkboxes are recorded in a separate sub-checklist bucket instead of being treated as task-completion controls.
...
- Normal route first task repetition hits: 5
...
- Normal route agenda/status repeated date meta rows: 4
...
- Task completion checkbox count: 23
- Task completion button count: 0
- Task completion mixed-control count: 0
- Sub-checklist checkbox count: 85
