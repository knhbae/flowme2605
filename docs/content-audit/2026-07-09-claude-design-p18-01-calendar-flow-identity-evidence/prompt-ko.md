...
주요 링크:
- P18 review package README: https://github.com/knhbae/flowme2605/blob/main/docs/content-audit/2026-07-09-claude-design-p18-01-calendar-flow-identity-evidence/README.md
- Audit markdown: https://github.com/knhbae/flowme2605/blob/main/docs/content-audit/2026-07-09-claude-design-p18-01-calendar-flow-identity-evidence/audit.md
- Review HTML: https://github.com/knhbae/flowme2605/blob/main/docs/content-audit/2026-07-09-claude-design-p18-01-calendar-flow-identity-evidence/review.html
- Route evidence JSON: https://github.com/knhbae/flowme2605/blob/main/docs/content-audit/2026-07-09-claude-design-p18-01-calendar-flow-identity-evidence/route-evidence.json
- Screenshots folder: https://github.com/knhbae/flowme2605/blob/main/docs/content-audit/2026-07-09-claude-design-p18-01-calendar-flow-identity-evidence/screenshots
...
{
  "totalScreenshots": 44,
  "uiBaselineCommit": "f13f8a1",
  "packageGeneratedFromCommit": "f13f8a1",
  ...
  "normalRouteRowControlAccessibleNameSampleCount": 8,
  "normalRouteRowControlAccessibleNameContextCount": 8,
