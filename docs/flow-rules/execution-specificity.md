...
- `real-fitvely-weekly-body-check`, `real-sinagong-computer-d30-study`, `real-pet-health-visit-routine`, and `real-mofa-overseas-travel-prep` remain broad-source routes below public MVP/representative framing until the required source work is done.
