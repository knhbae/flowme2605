...
- [x] Add RED coverage for the two ThankyouBUBU exact-source replacement routes.
- [x] Confirm the test fails while the routes still have five actions.
- [x] Rewrite both routes to one exact-video execution action.
