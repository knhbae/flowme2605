# URL-to-FLOW SourceRow-only Semantic Proposal Prompt v2.1

Prompt version: `url-to-flow-prompt-v2.1`  
...
Defect lock: use exactly one Item for every eligible primary row, no grouping or omission, and apply only the frozen rowType title, intent, and completion license.
<!-- DEFECT_REVISION_END -->
