...
- [2026-08-06 Workspace And Backlog Stabilization](./2026-08-06-workspace-backlog-stabilization/spec.md) is the active operations gate. It protects dirty work, integrates the P35 Round 2 source already deployed to production, reconciles project control, and establishes the clean baseline required before refactoring.
- No new product implementation spec is active. Text Authoring, content-review WIP, P35 P2 follow-ups, and research packages remain separate and must not be promoted implicitly by this maintenance work.
