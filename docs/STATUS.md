...
| Current release identity | [PR #178](https://github.com/knhbae/flowme2605/pull/178) final head `3cac3cde5bbcf6297b93b8299bfe28693700aebf` passed exact-head PR CI run [`31596540934`](https://github.com/knhbae/flowme2605/actions/runs/31596540934) and merged at `2026-08-12T12:42:45Z` as `908ee849beb15cb10331b72d7894167a61458b18`. Post-merge `main` run [`31597763288`](https://github.com/knhbae/flowme2605/actions/runs/31597763288) passed core job `94117373437` and Playwright job `94117373461`. |
| Current deployed source | GitHub Production deployment record `5869458520`, status `16715443863`, succeeded for merge `908ee849beb15cb10331b72d7894167a61458b18`. Its [protected direct URL](https://flowme2605-ej020et9m-flowme.vercel.app) is deployment-record evidence, not anonymous app proof. The [canonical alias](https://flowme2605.vercel.app) passed smoke `38/38`; the [Vercel deployment record](https://vercel.com/flowme/flowme2605/AF53jatbYV9EuNyjbUeMY3Z6gUWZ) reports success. |
| Evidence boundary | Canonical Production smoke passed `38/38` with workers `1`, retries `0`, in `99.6s`; unexpected, flaky, and skipped results were `0`. Exact-head PR CI, post-merge `main` CI, and deployment are successful. Automated QA, deployment, screenshots, and local capture reports are not observed-user validation; observed users remain `0`. |
...
| AI action now | Publish this documentation-only closeout, then preserve the release until a new gate is explicitly opened. |
...
| Browser regression | Canonical Production source `908ee849beb15cb10331b72d7894167a61458b18` | Smoke `38/38` passed with workers `1`, retries `0`, in `99.6s`; unexpected, flaky, and skipped results were `0`. This is automated production evidence, not observed use. |
...
| Previous R3B production release | [R3B QA](./specs/2026-08-11-r3b-approved-plan-execution-boundaries/qa.md) | PR #172 and hotfix PR #173 established the inherited approved execution contracts and canonical smoke `23/23`. PR #176 later replaced that runtime, and current PR #178 source `908ee849beb15cb10331b72d7894167a61458b18` preserves the inherited My Flow contracts. |
| Previous public plan surface release | [QA evidence](./specs/2026-08-12-public-plan-surface-unification/qa.md) | PR #176 merge `47c54803c6bb7544aad757ce62c4ce58decbfe53` and smoke `11/11` remain historical evidence; PR #178 merge `908ee849beb15cb10331b72d7894167a61458b18` is the current Production source. |
| Worktree baseline | `git worktree list` | Release documentation closeout is isolated in `flow-plan-edit-release-closeout-20260812` from `origin/main@908ee849`; user-owned and unrelated worktrees remain untouched. |
