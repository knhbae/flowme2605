...
- Mobile simulation session notes are in progress: the same three routes now have internal rehearsal findings and next observed-session script changes without changing validation status.
