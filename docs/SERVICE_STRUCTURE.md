...
Status: Living production baseline plus verified My Plan and Public Plan/Item edit candidates authorized for commit, Draft PR, and Preview. Merge and Production remain unauthorized; the production baseline is unchanged.
...
### Local Public Plan/Item Edit Candidate
...
- This candidate is authorized for commit, Draft PR, and Preview only. Merge
  and Production remain gated. Automated QA and screenshots are not
