...
export const realSourceNaturalArtifactAudits: RealSourceNaturalArtifactAudit[] = [
  ...
  },
  {
    ...
    currentContentGap: '2026-05-25 first reshape 이후 5-step starter Flow는 한 개 exact-video 실행 action으로 축소됐다. 남은 과제는 실제 사용자가 링크를 열고 기록까지 남기는지 관찰하는 것이다.',
    currentUxGap: '요약, 원본 영상, 운동 후 기록, 중단 조건은 한 detail panel에 모였지만 아직 대표/public MVP/validated 상태는 아니다.',
    nextContentAction: 'exact-video 실제 사용자 또는 시뮬레이션 세션에서 영상 열기, 캘린더 export, 운동 후 기록 입력이 막히는지 확인한다.',
    nextUxAction: '모바일 첫 화면에서 원본 영상 링크와 상태 기록이 과밀하지 않은지 스크린샷으로 확인한다.',
    decision: 'reshape_content_or_ux',
  },
  {
