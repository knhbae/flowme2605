...
- 이번 학기 신청기간(1차/2차) 확인하기 D-14
  why: 국가장학금은 정해진 신청기간을 지나면 해당 학기 신청이 불가능하고, 각 차수의 일정도 공지마다 달라집니다.
  ...
  caution: 공지에 적힌 신청 마감일과 마감 시각을 그대로 캘린더에 옮기고, 제출 전에 다시 확인합니다.
- 본인·가구원 인증 수단 준비하기 D-14
  why: 가구원 정보 제공 동의에 사용할 수 있는 인증 수단을 재단 안내에서 먼저 확인합니다.
- 학자금 지원구간 산정용 가구원 동의 대상 확인하기 D-14
  why: 가구원(부모 등) 정보제공 동의가 늦으면 소득분위 산정이 지연되어 심사 자체가 진행되지 않습니다.
  caution: 가구원 동의와 서류 제출 기한은 신청 기한과 다를 수 있으므로 이번 학기 공지에서 각각 확인합니다.
...
- 서류 제출 요청(필요 시) 마감 전 처리하기 D-Day
  caution: 지원구간별 금액과 등록금 범위는 학기별 안내에서 확인하고, 화면에 표시된 예상 금액을 개인 메모에 남깁니다.`,
  },
  {
    flow: {
...
- 전세 계약 조건이 보증 대상에 맞는지 확인하기
  ...
  caution: 보증 한도, 전세가율, 공시가격 적용 기준은 바뀔 수 있습니다. 주소·주택 유형·계약 금액을 기준으로 HUG에서 현재 가입 가능 여부를 확인하세요.
...
- 소득·재산·취업경험 기준으로 유형(Ⅰ/Ⅱ) 확인하기
  ...
  caution: 소득·재산·취업경험 기준과 구직촉진수당 금액은 변경될 수 있습니다. 고용24의 현재 모의 확인 결과와 고용센터 안내를 메모하세요.
...
- 상담 후 취업활동계획(IAP) 수립 일정 잡기
  caution: 취업활동계획과 정해진 활동을 이행해야 지원이 유지될 수 있습니다. 참여수당의 대상과 금액은 고용24에서 현재 기준을 확인하세요.`,
  },
  {
    flow: {
...
- 부과된 지방세 항목·금액·납부기한 확인하기
  ...
  how: 위택스에서 내 지방세 부과·납부 내역과 현재 이용 가능한 조회 항목을 확인합니다.
