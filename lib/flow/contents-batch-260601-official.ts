...
- 2차 검진 예약 D+120~D+150
  why: 생후 4~5개월 사이 검진입니다. 신체·운동 발달을 점검합니다.
  how: 공단 앱에서 2차 가능 의료기관을 조회하고 예약합니다.
  done: 2차 검진을 예약했다.
- 3차 검진 예약 D+270~D+330
  why: 생후 9~11개월 사이 검진입니다.
  done: 3차 검진을 예약했다.
- 4차 검진 + 1차 구강검진 D+540~D+690
  why: 생후 18~23개월 검진입니다. 이 시기에 1차 구강검진(18~29개월)도 함께 확인합니다.
  done: 4차 일반검진과 1차 구강검진 일정을 확인했다.
  caution: 발달 관련 우려가 있으면 검진 결과를 의료진과 상담합니다.
- 5차 검진 + 2차 구강검진 D+900~D+1050
  why: 생후 30~35개월 검진입니다. 2차 구강검진(30~41개월)도 함께 챙깁니다.
  done: 5차 일반검진과 2차 구강검진 일정을 확인했다.
- 6차 검진 + 3차 구강검진 D+1260~D+1410
  why: 생후 42~47개월 검진입니다. 3차 구강검진(42~53개월)도 함께 챙깁니다.
  done: 6차 일반검진과 3차 구강검진 일정을 확인했다.
- 7차 검진 + 4차 구강검진 D+1620~D+1770
  why: 생후 54~59개월 검진입니다. 4차 구강검진(54~65개월)도 함께 챙깁니다.
...
- 구매 예정 차종의 국고·지자체 보조금 확인하기
  ...
  caution: 국고보조금에 더해 지자체 보조금이 합산됩니다(2026년에는 노후차 폐차 후 전환 시 전환지원금이 추가되는 등 항목이 바뀌므로 정확한 금액은 누리집에서 확인). 예산이 상반기에 소진되는 경향이 있으니 공고 직후 신속하게 신청하세요.
- 거주지 신청 자격·우선순위 확인하기
