...
- 우리 아이 검진 차수와 가능 기간 확인하기
  ...
  caution: 일반검진은 생후 14일~71개월에 총 8회(14~35일, 4개월, 9개월, 18개월, 30개월, 42개월, 54개월, 66개월대), 구강검진은 별도로 총 4회(1차 18~29개월, 2차 30~41개월, 3차 42~53개월, 4차 54~65개월)입니다. 월령별 정확한 가능 기간은 검진일자 조회로 확인하세요.
- 구강검진 차수도 함께 확인하기
