      ...
      actions: [
        {
          ...
          how: `요약: ${video.focus}를 이번 주 운동표에 반영할 기준 1개로 좁힙니다. 준비: 원본 영상 링크를 열고 이번 주 운동표에서 바꿀 칸을 하나 정합니다. 선택 기준: 원본 영상에서 오늘 필요한 순서, 분할, 세트, 휴식, 중량, 식사 타이밍 중 하나만 고릅니다. 주간 운동표: 선택한 기준을 이번 주 운동 요일, 회차 순서, 적용 부위, 세트/휴식 메모 중 필요한 칸에 적습니다. 원본 영상: 기준을 고른 이유와 예외는 YouTube 링크를 열어 확인합니다. 실행: 오늘 운동에 선택한 기준을 적용하고 무리하지 않는 강도로 진행합니다. 기록: 적용한 기준, 실제 수행 여부, 피로도, 통증/호흡 문제, 다음 회차 조정 메모를 남깁니다. 수정 조건: 통증, 과한 피로, 호흡 곤란, 회복 부족, 일정 충돌이 있으면 중단하거나 주간 운동표를 수정하고 전문가 상담을 우선합니다.`,
    ...
    actions: [
      {
        ...
        how: `요약: ${video.focus}를 전체 식단 계획이 아니라 오늘 적용할 행동 1개로 좁힙니다. 적용 기준: ${video.applicationTarget ?? '다음 식사 한 끼나 오늘 운동 전후 행동 하나'}에만 적용합니다. 원본 영상: 원칙의 이유와 예외는 YouTube 링크를 열어 확인합니다. 준비: 영상 링크를 열고 오늘 쓸 기준만 하나 고릅니다. 실행: 선택한 기준을 다음 식사나 운동 전후 행동에만 반영합니다. 기록: 적용한 음식/시간/몸 상태/허기/폭식 유발감/유지 여부를 메모합니다. 중단 조건: 무리한 제한, 어지러움, 통증, 폭식 유발감, 기존 질환 우려가 있으면 멈추고 전문가 상담을 우선합니다. 마무리: 같은 기준을 한 번 더 적용할지, 수정하거나 중단할지 정합니다.`,
        completion_criteria: '오늘 적용할 기준 1개를 실제 식사나 운동 전후 행동에 반영했고, 몸 상태와 유지/중단 여부를 기록했습니다.',
        caution:
...
const realSourceSpecs: RealSourceSpec[] = [
    ...
    actions: [
      {
        ...
        how: '요약: 점프, 눕는 동작, 반복, 토크를 줄인 ThankyouBUBU 전신 운동 영상을 이번 주 반복 일정에 넣습니다. 상세히 보기: 팔을 벌릴 수 있는 공간, 매트, 물, 수건을 준비하고 원본 영상을 엽니다. FLOW는 동작 순서를 새로 처방하지 않고, 영상의 자세와 박자를 보면서 오늘 가능한 강도로 따라 하도록 정리합니다. 원본 영상: 정확한 동작 설명과 속도는 YouTube 링크를 열어 확인합니다. 운동 후 기록: 완료 여부, 체감 난이도, 통증이나 어지러움, 다음 회차 강도 조정 메모를 남깁니다. 마무리: 같은 영상을 다음 일정에 반복할지, 쉬운 강도로 낮출지 결정합니다.',
    ...
    actions: [
      {
        ...
        how: '요약: ThankyouBUBU의 고강도 전신 운동 영상을 주 3회 반복 일정에 넣고 한 회차씩 실행합니다. 상세히 보기: 운동 전후 여유 시간을 포함해 요일과 시간을 정하고, 매트, 물, 수건을 준비한 뒤 원본 영상을 엽니다. FLOW는 동작 순서를 새로 만들지 않고, 영상의 자세와 박자를 기준으로 따라 하되 호흡이 과하게 가쁘거나 자세가 무너지면 반복 수와 강도를 낮추도록 안내합니다. 원본 영상: 정확한 동작 설명, 속도, 쉬는 타이밍은 YouTube 링크를 열어 확인합니다. 운동 후 기록: 완료/절반 완료/중단, 체감 난이도 1-5, 통증이나 어지러움, 다음 회차 강도 조정 메모를 남깁니다. 마무리: 3회 중 2회 이상 무리 없이 끝냈으면 유지하고, 아니면 다음 주 강도를 낮춥니다.',
  ...
  },
  {
    ...
    source_precision: 'exact',
    risk_level: 'medical_sensitive',
    conversion_note: 'FITVELY 영양학 영상을 식단 기록 기준과 주간 조정 메모로 전환했습니다.',
