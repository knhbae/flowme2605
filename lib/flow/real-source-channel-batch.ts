    ...
    actions: [
      {
        ...
        how: `요약: ${video.focus}를 전체 식단 계획이 아니라 오늘 적용할 행동 1개와 관찰표 1행으로 좁힙니다. 기준 후보: 원본 영상에서 오늘 비교하거나 적용할 기준을 확인하고, ${video.applicationTarget ?? '다음 식사 한 끼나 오늘 운동 전후 행동 하나'}에 쓸 기준 하나만 고릅니다. 적용 기준: 선택한 기준을 다음 식사나 운동 전후 행동 한 번에만 반영합니다. 관찰표: 날짜, 적용한 식사/운동 전후 행동, 선택 기준, 컨디션, 허기나 제한감, 유지/중단 결정을 같은 행에 적습니다. 원본 영상: 원칙의 이유와 예외는 YouTube 링크를 열어 확인합니다. 준비: 영상 링크를 열고 오늘 쓸 기준만 하나 고릅니다. 실행: 선택한 기준을 다음 식사나 운동 전후 행동에만 반영합니다. 기록: 적용한 음식/시간/몸 상태/허기/폭식 유발감/유지 여부를 관찰표에 남깁니다. 중단 조건: 무리한 제한, 어지러움, 통증, 폭식 유발감, 기존 질환 우려가 있으면 멈추고 전문가 상담을 우선합니다. 마무리: 같은 기준을 한 번 더 적용할지, 수정하거나 중단할지 정합니다.`,
        completion_criteria: '오늘 적용할 기준 1개를 실제 식사나 운동 전후 행동에 반영했고, 관찰표에 몸 상태와 유지/중단 여부를 기록했습니다.',
        caution:
