...
const realSourceSpecs: RealSourceSpec[] = [
  ...
  },
  {
    ...
    conversion_note: '점프와 눕는 동작을 줄인 전신 운동 영상을 초보 시작 루틴의 준비, 실행, 기록 흐름으로 전환했습니다.',
    ...
    actions: [
      {
        ...
        caution: '원본 영상의 자세와 속도를 확인하고 통증이나 어지러움이 있으면 중단하세요.',
      },
      {
        title: '오늘 가능한 강도 선택',
        why: '몸 상태와 맞지 않는 강도는 루틴 지속보다 중단 가능성을 높입니다.',
        how: '원본 영상을 열고 오늘은 끝까지 따라 할지, 쉬운 강도로 줄일지 먼저 정합니다.',
        completion_criteria: '오늘 실행할 원본 영상과 조정 강도를 정했습니다.',
      },
      {
        title: '워밍업과 관절 상태 확인',
  ...
  },
  {
    ...
    source_precision: 'exact',
    risk_level: 'medical_sensitive',
    conversion_note: '19분가량의 전신 운동 영상을 주간 반복 루틴과 난이도 조정 기준으로 전환했습니다.',
    warning: '운동 중 통증이나 어지러움이 있으면 중단하고 전문가 상담을 권장합니다.',
    tags: ['운동', '루틴', 'creator'],
    ...
    actions: [
      {
        ...
        how: '일주일 중 쉬는 날을 포함해 원본 영상을 열 수 있는 요일 3개를 고릅니다.',
        completion_criteria: '이번 주 운동 요일 3개를 캘린더에 적었습니다.',
      },
      {
        title: '원본 영상 실행 시간대 고정',
        why: '운동 전후 정리 시간을 고려하지 않으면 루틴이 자주 밀립니다.',
        how: '원본 영상 실행 시간과 준비 5분을 합쳐 같은 시간대에 배치합니다.',
