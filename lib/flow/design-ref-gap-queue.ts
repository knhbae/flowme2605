...
export const designRefGapQueueItems: DesignRefGapQueueItem[] = [
  ...
  },
  {
    ...
    nextAction: 'Add a score/chapter summary card before source-derived study rows on narrow screens.',
  ...
  },
  {
    ...
    nextAction: 'Surface today meal slot, new ingredient, reaction, and allergy-watch cue before recipe details.',
    statusAfterAlignment: 'pending design-ref alignment, not validated until real user behavior exists.',
  },
  {
    ...
    nextAction: 'Bundle task scripts, expected artifacts, failure signals, and screenshots for one moderated mobile session.',
    statusAfterAlignment: 'pending observed-session prep, not validated until real user behavior exists.',
  },
];
