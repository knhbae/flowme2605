...
export function getContentLabSummary(bundles: FlowBundle[]) {
  ...
  return {
    ...
    representativeReadinessTotalCount: representativeReadinessSummary.totalCount,
    ...
    representativeUxContentReviewTotalCount: representativeUxContentReviewSummary.totalCount,
