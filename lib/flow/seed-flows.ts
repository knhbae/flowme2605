...
> = {
  ...
  'passport-renewal-docs': {
    ...
    source_precision: 'exact',
    source_checked_at: '2026-05-23',
    conversion_note: '정부24 여권 발급 안내 기반 Flow입니다. 사용자 여정 확인 전 검토 대기 상태입니다.',
    primary_destination: 'memo',
  },
...
const babyFoodBundle: FlowBundle = {
  flow: {
    ...
    source_checked_at: '2026-06-07',
    conversion_note:
      '원문은 아기마다 시작일이 달라 날짜를 직접 입력하는 식단표를 제공하고, 쌀/찹쌀/채소를 3일 단위로 먹이며 새 재료 반응을 보는 흐름입니다. Flow에서는 관찰 기록 앱이 아니라 시작일 기준 식단 달력과 레시피 메모로 옮깁니다.',
    primary_destination: 'calendar',
    warning: babyWarning,
    ...
    makeTextBundle(
      {
        ...
        conversion_note: '입주 사전점검 원문에서 준비물, 구역별 하자 확인, 보수 요청 흐름만 뽑아 checklist+calendar 형태로 변환했습니다.',
    ...
    makeTextBundle(
      {
        ...
        source_precision: 'exact',
        source_checked_at: '2026-06-04',
        conversion_note: '출국 전 구매/설치/도착 후 연결이라는 실행 단위를 calendar+memo 형태로 변환했습니다.',
        primary_destination: 'calendar',
    ...
    makeTextBundle(
      {
        ...
        status: 'published',
        risk_level: 'medical_sensitive',
        source_title: '국민건강보험 건강iN 영유아 건강검진 웹 서비스 안내',
        source_url: 'https://www.nhis.or.kr/magazin/mobile/201604/c09.html',
        source_status: 'needs_review',
        source_precision: 'exact',
        source_checked_at: '2026-06-08',
        ...
        links: [
          {
            ...
            url: 'https://www.nhis.or.kr/magazin/mobile/201604/c09.html',
            type: 'official',
          },
        ],
        source_type: 'official',
    ...
    makeTextBundle(
      {
        ...
        source_precision: 'exact',
        source_checked_at: '2026-06-08',
        conversion_note: '토토북 독서 지도안의 읽기 전/읽는 중/읽은 후 구조와, 그림책 하브루타 리뷰의 질문·후기 단서를 독서 루틴에 붙는 질문 카드로 변환했습니다. 책별 학습 성과, 발달 평가, 독서 수준 판정은 넣지 않고 오늘 책, 질문 카드, 아이 말 한 줄, 다음 책 후보만 남깁니다.',
        primary_destination: 'hybrid',
    ...
    makeTextBundle(
      {
        ...
        source_precision: 'exact',
        source_checked_at: '2026-06-07',
        conversion_note: '공룡 놀이 자료에서 준비물과 활동 순서만 추려 주말 일정과 내부 체크리스트로 변환했습니다. 반복 회차나 발달 평가, 사진 증빙은 기본으로 요구하지 않습니다.',
        primary_destination: 'hybrid',
