...
| 필드 | 요구 사항 | 현재 값 |
|---|---|---|
| `product_candidate_sha` | 검토 대상 제품 commit SHA | `83c3a72629ba2bad634f117f1f8077de8aa0e045` |
| `product_candidate_ref` | branch/tag 설명용 값; SHA를 대신하지 않음 | `codex/p35-round2-candidate-20260805 → origin/codex/p35-round2-candidate-20260805@83c3a72629ba2bad634f117f1f8077de8aa0e045` |
...
| `build_id` | candidate에서 생성된 runtime build identity | `k7ouW_TvxXXQiPeyjALDo` |
| `build_command` | 정확한 명령과 exit code | `npm.cmd run build` · exit `0` |
| `build_log_sha256` | 전체 build log SHA-256 | [direct build log](https://raw.githubusercontent.com/knhbae/flowme2605/3a924b931157a36204b7ddfaee83ca2991e2cce1/evidence/candidate/build.log) · `267559b028ccebdcd1b5dfe3c8396d5d0469200c6f11d73770d5846b103e0f93` |
| `runtime_build_identity` | served /flows HTML이 같은 BUILD_ID를 포함하는지 확인 | `PASS` · HTTP `200` · contains `true` · `3dc11a654011af0557b2351027a3b4877639a1c17bb13b6c43544cca508ba206` |
| `blind_evidence_publication_sha` | capture·raw artifact를 먼저 게시한 blind-only asset commit A SHA | `3a924b931157a36204b7ddfaee83ca2991e2cce1` |
...
| `blind_publication_transport` | role별 allowlist의 file-level direct URL만 사용 | `3a924b931157a36204b7ddfaee83ca2991e2cce1` · verified via role-specific allowlist |
| `runtime_url` | Codex 전용 URL; Claude 입력이 아님 | `CODEX_ONLY_NOT_DISCLOSED` |
| `seed_reset_command` | fixture 초기화 명령과 결과 | `npm.cmd run evidence:p35-round2:rehearse` · `THREE_GROUP_MANIFESTS_CAPTURED` · `090a72e3d4b6bb46df81ddf5ca4a75d1ae32ad0fdb58fd06ecfa2a9757be2765` |
| `seed_manifest_sha256` | seed/fixture manifest SHA-256 | `090a72e3d4b6bb46df81ddf5ca4a75d1ae32ad0fdb58fd06ecfa2a9757be2765` |
| `captured_at_kst` | capture 시작/종료 시각 | `2026-08-05T14:54:32+09:00 → 2026-08-05T14:55:00+09:00` |
