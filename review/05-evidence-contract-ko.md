...
| `product_clean_tree_proof` | candidate checkout의 git status --short --branch 원문 | [direct proof](https://raw.githubusercontent.com/knhbae/flowme2605/55fab7dc22b8de6c6cf8a2fba44f3a658fc2566d/evidence/candidate/git-status-short-branch.txt) · `## codex/p35-round2-candidate-20260805...origin/codex/p35-round2-candidate-20260805` |
| `product_clean_tree_proof_sha256` | 위 원문 파일 SHA-256 | `08411ee7d7ddd20c5f49af3c2d2a88c5cef9dc9202cf333436ee76519fc5a031` |
| `build_id` | candidate에서 생성된 runtime build identity | `6hGywJa2x9eHc-II5umLx` |
| `build_command` | 정확한 명령과 exit code | `npm.cmd run build` · exit `0` |
| `build_log_sha256` | 전체 build log SHA-256 | [direct build log](https://raw.githubusercontent.com/knhbae/flowme2605/55fab7dc22b8de6c6cf8a2fba44f3a658fc2566d/evidence/candidate/build.log) · `907053435b266b69f7691e5480aac1ca32de5c93d8696f0b7bfff604c1600392` |
| `runtime_build_identity` | served /flows HTML이 같은 BUILD_ID를 포함하는지 확인 | `PASS` · HTTP `200` · contains `true` · `cabd24bb30afe2a1ad3a506515939ba7d6a2c1f01026f608842d41d2aac9a47e` |
| `blind_evidence_publication_sha` | capture·raw artifact를 먼저 게시한 blind-only asset commit A SHA | `55fab7dc22b8de6c6cf8a2fba44f3a658fc2566d` |
...
| `blind_publication_transport` | role별 allowlist의 file-level direct URL만 사용 | `55fab7dc22b8de6c6cf8a2fba44f3a658fc2566d` · verified via role-specific allowlist |
| `runtime_url` | Codex 전용 URL; Claude 입력이 아님 | `CODEX_ONLY_NOT_DISCLOSED` |
| `seed_reset_command` | fixture 초기화 명령과 결과 | `npm.cmd run evidence:p35-round2:rehearse` · `THREE_GROUP_MANIFESTS_CAPTURED` · `abc6c7db8d5de10e922b241e019e4a39840d56e6840f970c7476fb8904433e06` |
| `seed_manifest_sha256` | seed/fixture manifest SHA-256 | `abc6c7db8d5de10e922b241e019e4a39840d56e6840f970c7476fb8904433e06` |
| `captured_at_kst` | capture 시작/종료 시각 | `2026-08-05T17:33:13+09:00 → 2026-08-05T17:33:33+09:00` |
