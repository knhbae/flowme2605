...
| 필드 | 요구 사항 | 현재 값 |
|---|---|---|
| `product_candidate_sha` | 검토 대상 제품 commit SHA | `29cb03a65dd1037a3b813b7f43a5a095e4669dce` |
| `product_candidate_ref` | branch/tag 설명용 값; SHA를 대신하지 않음 | `codex/p35-round2-candidate-20260805 → origin/codex/p35-round2-candidate-20260805@29cb03a65dd1037a3b813b7f43a5a095e4669dce` |
| `product_clean_tree_proof` | candidate checkout의 git status --short --branch 원문 | [direct proof](https://raw.githubusercontent.com/knhbae/flowme2605/64d5651df657c91e793dd1212788e293d6937947/evidence/candidate/git-status-short-branch.txt) · `## codex/p35-round2-candidate-20260805...origin/codex/p35-round2-candidate-20260805` |
| `product_clean_tree_proof_sha256` | 위 원문 파일 SHA-256 | `08411ee7d7ddd20c5f49af3c2d2a88c5cef9dc9202cf333436ee76519fc5a031` |
| `build_id` | candidate에서 생성된 runtime build identity | `V29H3kpreESrdkYwzy_q9` |
| `build_command` | 정확한 명령과 exit code | `npm.cmd run build` · exit `0` |
| `build_log_sha256` | 전체 build log SHA-256 | [direct build log](https://raw.githubusercontent.com/knhbae/flowme2605/64d5651df657c91e793dd1212788e293d6937947/evidence/candidate/build.log) · `cf69325625f543255a9e2878544823c428d2242a258522922d6f3c2f2097646a` |
| `runtime_build_identity` | served /flows HTML이 같은 BUILD_ID를 포함하는지 확인 | `PASS` · HTTP `200` · contains `true` · `dade8b4fa9439f63cc861d933f42d891013ec70ff9661234d0a78f4e39afc1c3` |
| `blind_evidence_publication_sha` | capture·raw artifact를 먼저 게시한 blind-only asset commit A SHA | `64d5651df657c91e793dd1212788e293d6937947` |
...
| `blind_publication_transport` | role별 allowlist의 file-level direct URL만 사용 | `64d5651df657c91e793dd1212788e293d6937947` · verified via role-specific allowlist |
| `runtime_url` | Codex 전용 URL; Claude 입력이 아님 | `CODEX_ONLY_NOT_DISCLOSED` |
| `seed_reset_command` | fixture 초기화 명령과 결과 | `npm.cmd run evidence:p35-round2:rehearse` · `THREE_GROUP_MANIFESTS_CAPTURED` · `ecbba7c87a8c8f96e3e66d65a1bf2f2b4d59616ce0f4e5ad67f7f5439ff81a27` |
| `seed_manifest_sha256` | seed/fixture manifest SHA-256 | `ecbba7c87a8c8f96e3e66d65a1bf2f2b4d59616ce0f4e5ad67f7f5439ff81a27` |
| `captured_at_kst` | capture 시작/종료 시각 | `2026-08-05T18:16:16+09:00 → 2026-08-05T18:16:53+09:00` |
