...
const representativeExperienceSpecs: Record<string, ExperienceSpec> = {
  ...
  'car-inspection-renewal-window': {
    ...
    surface: 'calendar',
    resultTitle: '검사 만료일 기준 예약과 재검사 기한을 놓치지 않는 차량 Flow',
    sourceSummary: [
      'TS 원문은 관능검사, ABS검사, 하체검사, 전조등검사, 배출가스검사, 검사결과 설명 흐름을 안내한다.',
      '종합검사 대상과 차종별 유효기간이 표로 정리되어 있어 만료일 기준 일정으로 옮기기 좋다.',
      '부적합 시 재검사기간이 있으므로 검사 완료가 아니라 결과 확인과 재검사 예약이 핵심이다.',
    ],
    sourceTrace: [
      { source: '차종별 유효기간과 종합검사 대상 정보가 있다.', artifact: '만료 45일 전 대상과 유효기간 확인 일정이 생깁니다.' },
      { source: '검사는 예약과 준비물이 필요하다.', artifact: '만료 30일 전 검사소 예약과 자동차등록증 확인 체크가 있습니다.' },
    ...
    saveResult: '만료 45일 전, 30일 전, 검사 당일, 부적합 시 재검사 체크가 캘린더에 저장됩니다.',
    ...
    executionCards: [
      { title: '검사 대상과 유효기간 확인', meta: '만료 45일 전', body: '비사업용 승용차 등 내 차량의 검사 주기와 종합검사 대상 지역 여부를 TS 안내에서 확인합니다.', status: '대상 확인' },
      { title: '검사소 예약과 준비물 확인', meta: '만료 30일 전', body: '검사소 예약, 자동차등록증 등 준비 항목, 결제 방식을 확인합니다.', status: '예약' },
    ...
    detailTitle: '검사소 예약과 준비물 확인',
    detailMeta: '만료 30일 전 · 공식검사',
    detailMemo: '검사소 예약, 자동차등록증 등 준비 항목, 결제 방식을 확인합니다. 검사 판정이나 정비 견적은 Flow가 판단하지 않고, 결과서와 정비업체 확인으로 남깁니다.',
    detailChecks: ['검사소 후보 확인', '예약일 저장', '자동차등록증 준비', '결제 방식 확인', '결과서 저장 위치 메모'],
