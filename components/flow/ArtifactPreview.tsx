...
export function ArtifactPreview({ bundle }: { bundle: FlowBundle }) {
  ...
  return (
    <section className="mb-5 rounded-xl border border-blue-100 bg-blue-50/70 p-4" aria-label="Flow artifact preview">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-xs font-semibold uppercase text-blue-700">이 Flow가 만들어주는 것</p>
