    ...
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        <p className="text-[var(--flowme-text-tertiary)]">
          입력은 구조와 결과에 바로 반영되며, 붙여 넣은 원문은 그대로
          보존됩니다.
        </p>
      </div>
      ...
      <section>
        ...
        <p className="mt-2 text-[var(--flowme-text-tertiary)]">
          ...
          원문에 남고 자동으로 항목이 되지 않습니다. 붙여 넣은 <code># 제목</code>은
          위 제목란과 연결됩니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2">
          기준일이 있어야 <code>D-3</code>을 실제 캘린더 날짜로 계산합니다. 화면에서
          기준일을 바꾸면 원문의 기준일 줄도 함께 바뀝니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2 font-semibold text-[var(--flowme-warning-strong)]">
          반복과 조건은 현재 초안에 문구만 보존합니다. 반복 회차 생성과 캘린더
          반복 내보내기는 아직 지원하지 않습니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2">
          ...
          <code>- [ ]</code>를 붙이세요. URL만 입력하면 본문을 추측하지 않고 원문을
          가져와야 하는 상태로 남깁니다.
        </p>
      </section>
    </div>
      ...
      >
        ...
        <div className="block">
          <div className="flex flex-wrap items-center gap-2 text-xs font-semibold text-[var(--flowme-text-secondary)]">
            <label htmlFor="text-authoring-source">원문 또는 메모</label>
            <InlineHelp
              label="작성 문법 설명"
          ...
          <span id="text-authoring-source-hint" className="sr-only">
            작성 문법은 원문 또는 메모 옆 물음표 버튼에서 확인할 수 있습니다.
          </span>
